...
//        cameraFbo.allocate(4000,4000, GL_RGBA);
        // TODO: change the allocation size up to smart phone resolution
        cameraFboWidth = ofGetWidth();
        cameraFboHeight = ofGetHeight();
        cameraFbo.allocate(cameraFboWidth, cameraFboHeight, GL_RGBA);
